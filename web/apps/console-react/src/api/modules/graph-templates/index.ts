...
export const graphTemplatesApi = {
  ...
  suggestTemplateParams(data: { content: string }): Promise<SuggestTemplateParamsResponse> {
    return service
      .post('/api/graph-templates/suggest-template-params', data)
      .then(res => res.data)
      .catch(handleError)
  },
}
