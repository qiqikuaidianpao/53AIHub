          ...
          <>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1">
                <h3 className="text-base text-primary">{t("bailian")}</h3>
                <Popover
                  content={
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: t("bailian_agent_get_tip", {
                          url: `<a class='text-link underline' href='https://bailian.console.aliyun.com/?tab=app#/app-center' target='_blank'>https://bailian.console.aliyun.com/?tab=app#/app-center</a>`,
                        }),
                      }}
                    />
                  }
