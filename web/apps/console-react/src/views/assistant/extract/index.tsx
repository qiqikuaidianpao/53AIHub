        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between gap-2.5">
              ...
              <div className="flex-1 text-sm font-medium text-[#1D1E1F]">文档问答</div>
              <Switch />
            </div>
          ...
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between gap-2.5">
              <div className="size-6"></div>
              <div className="flex-1 text-sm font-medium text-[#1D1E1F]">知识萃取</div>
              <Switch />
            </div>
            <p className="text-xs text-[#999999] mt-3">
          ...
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between gap-2.5">
              <div className="size-6"></div>
              <div className="flex-1 text-sm font-medium text-[#1D1E1F]">AI播客</div>
              <Switch />
            </div>
            <p className="text-xs text-[#999999] mt-3">
