...
/** 向后兼容 console 的命名 */
export const ResponseCode = RESPONSE_CODE
...
/** 向后兼容 console 的命名 */
export const ResponseStatus = RESPONSE_STATUS

export const ResponseMessage = {
  Canceled: 'canceled',
} as const

export const RESPONSE_CODE_MESSAGE_MAP = new Map<number, string>([
...
export const RESPONSE_MESSAGE_MAP = new Map<string, string>([
